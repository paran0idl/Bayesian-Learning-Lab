...
The joint posterior of $\mu$ and $\phi$ are concentrated around parameters' mean. The joint posterior distribution seems normally distributed, since we know the data is simulated using normal distribution, it is possible to conclude that the model constructed for sampling described the data well.
...
In this case, $x_t$ should be seen as parameter.
